...
export default function FigmaEventsGallery() {
  ...
  return (
    <section className="min-h-[calc(100vh-72px)] min-h-[calc(100svh-72px)] flex flex-col justify-center py-4 sm:py-6 lg:py-8 bg-navy-900 text-white border-b border-navy-800 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-3 sm:space-y-4 w-full my-auto">
        {/* Streamlined Sleek Header */}
        <ScrollReveal delay={0.1} className="flex flex-row items-center justify-between gap-4 border-b border-navy-800/80 pb-3">
          <div>
            <h2 className="text-lg sm:text-2xl lg:text-3xl font-serif font-normal text-white tracking-tight">
          ...
          <div className="shrink-0">
            <Link
              href="/events"
              className="inline-flex items-center space-x-2 text-[11px] sm:text-xs uppercase font-bold tracking-widest text-slate-200 hover:text-electric-light transition-colors group border border-white/20 hover:border-electric px-3 sm:px-4 py-1.5 sm:py-2 rounded"
            >
        ...
        {/* 3D Depth Carousel Showcase (Substantially Enlarged) */}
