    ...
    <section className="bg-navy-900 border-b border-navy-800">
      <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[520px]">
        ...
        <div className="lg:col-span-7 relative h-72 lg:h-auto min-h-[320px] overflow-hidden">
          ...
          {/* Bottom Tabs Badge */}
          <div className="absolute bottom-4 left-4 flex space-x-2 text-[10px] font-mono uppercase tracking-widest text-slate-300 bg-navy-950/80 backdrop-blur-sm px-3 py-1.5 rounded border border-white/10">
            <span>INTER-TOC</span>
        ...
        <div className="lg:col-span-5 bg-navy-950 p-8 sm:p-12 lg:p-16 flex flex-col justify-center space-y-6 text-white border-t lg:border-t-0 lg:border-l border-navy-800">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-normal leading-[1.12]">
            Trademark<br />
            Opposition<br />
          ...
          <div className="pt-2">
            <Link
              href="/events/toc"
              className="inline-flex items-center space-x-2 text-xs uppercase font-bold tracking-widest text-slate-200 hover:text-electric-light transition-colors group"
            >
